...
#     Robolink()
#     Item()
# These classes are the main objects used to interact with RoboDK and create macros.
...
class Robolink:
    ...
    def Disconnect(self):
        """Stops the underlying communication with RoboDK. Any programs pending to be created will be generated."""
        self.COM.close()
...
class Item():
    ...
    def MakeProgram(self, filestr='', run_mode = RUNMODE_MAKE_ROBOTPROG):
        """Generates a program.
        In  1 : string -> File path of the program. It can be left empty to use the default action (promt or rewrite)
        In  2 : int -> run mode: RUNMODE_MAKE_ROBOTPROG just generate the program. Use RUNMODE_MAKE_ROBOTPROG_AND_UPLOAD or RUNMODE_MAKE_ROBOTPROG_AND_START to transfer the program through FTP and execute the program.        
    ...
    def RunProgram(self, prog_parameters=None):
        """Using RunProgram for backwards compatibility. Use RunCode instead."""
